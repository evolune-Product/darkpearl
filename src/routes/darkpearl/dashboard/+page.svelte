<script lang="ts">
  ...
  import EditKitDialog from "./components/EditKitDialog.svelte";
  import DeleteKitDialog from "./components/DeleteKitDialog.svelte";
  ...
  function get_new_project_url(): string {
    return selected_kit_id
      ? `/darkpearl/new?kit=${selected_kit_id}`
      : "/darkpearl/new";
  }
...
<svelte:head>
  <title>Dashboard - darkpearl</title>
</svelte:head>
...
<div class="min-h-screen bg-[var(--builder-bg-primary)] safe-area-top">
  ...
  <header class="border-b border-[var(--builder-border)] py-4">
    <div class="max-w-6xl mx-auto px-6 flex items-center justify-between">
      <div class="flex items-center gap-8">
        <a href="/darkpearl" class="hover:opacity-80 transition-opacity">
          <Logo width="4rem" />
        </a>
      </div>
      ...
      <div class="flex items-center gap-3">
        <a
          href="/darkpearl/screenshot-to-code"
          target="_blank"
          rel="noopener noreferrer"
          class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-[var(--builder-text-secondary)] hover:text-[var(--builder-text-primary)] hover:bg-[var(--builder-bg-secondary)] rounded-md transition-colors"
          title="Screenshot to Code"
        >
          <Camera class="w-4 h-4" />
          <span class="hidden sm:inline">Screenshot to Code</span>
        </a>
        <a
          href="/darkpearl"
  ...
  <!-- Footer -->
  <footer class="border-t border-[var(--builder-border)] py-6 mt-8">
    <div class="max-w-6xl mx-auto px-6 text-center text-sm text-[var(--builder-text-muted)]">
      <p>
        &copy; 2026 darkpearl. A product of <a href="https://evolune.in/" target="_blank" rel="noopener noreferrer" class="text-[var(--builder-accent)] hover:underline">Evolune EdgeTech</a>
      </p>
    </div>
  </footer>
</div>
