<script lang="ts">
    ...
    import * as api from "$darkpearl/lib/api.svelte";
    import { getProjectContext } from "$darkpearl/context";
    import { getProjectStore } from "$darkpearl/studio/project.svelte";
...
import { env, queue } from '$darkpearl'
...
/*
  Ideas or feedback? https://github.com/darkpearl-studio/darkpearl/discussions
*/`;
