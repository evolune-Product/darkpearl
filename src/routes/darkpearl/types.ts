// Shared types for darkpearl admin interface

// Kit type (matches Pocketbase _dp_kits collection)
export type Kit = {
	id: string
	name: string
	icon: string
...
// Project type (matches Pocketbase _dp_projects collection)
export type Project = {
	id: string
	collectionId?: string
	name: string
