 ...
 * @param {Object} [options.darkpearl_modules={}] - Content/design/data for SSR (inlined during server render).
 ...
 */
export async function html({ component, head, buildStatic = true, css = 'external', format = 'esm', dev_mode = false, sourcemap = false, runtime = [], darkpearl_modules = {} }) {
	let cache_key
	if (!buildStatic) {
