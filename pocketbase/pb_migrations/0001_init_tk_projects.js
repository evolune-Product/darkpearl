...
// Creates darkpearl collections: _dp_projects and _dp_settings
migrate((app) => {
	// _dp_projects - stores user projects
	...
	// _dp_settings - stores app configuration (LLM keys, etc)
	...
	app.delete(projects)
	const settings = app.findCollectionByNameOrId("_dp_settings")
